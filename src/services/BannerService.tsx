...
class BannerService {
  ...
  getBannerHasMaxId = () => {
    return axios.get(`/api/banners/max-id`);
  };
  ...
  getBannerMappingByBannerIdAndPageId = (bannerId: number, pageId: number) => {
    return axios.get(`api/banner-mapping/get-position/${bannerId}/${pageId}`);
  };
