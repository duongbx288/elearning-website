...
from ..function_package import content_base_function, read_data_function
...
class CB(object):
    ...
    def __init__(self, movies_csv):
        self.movies = read_data_function.get_dataframe_movies_csv(movies_csv)
    ...
    def build_model(self):
        ...
        self.tfidf_matrix = content_base_function.tfidf_matrix(self.movies)
        self.cosine_sim = content_base_function.cosine_sim(self.tfidf_matrix)
